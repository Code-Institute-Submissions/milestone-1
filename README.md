...
* **Features 7 - _Bouncing arrow down_**
...
* **CSS limitations:** _To use JavaScript to edit default browser styles._
...
* **Other Feature Ideas:** _Some ideas of possible features in the future_.
...
* I used Font Awesome Favicon Generator tool, to create a favicon from a selection of font awesome icons.
...
**Questionable Issue:** _When testing on Chrome device emulators, I noticed that when scrolling over YouTube videos and music players on mobile devices seems to lose its focus. When I tested this on a real mobile device, this does not happen and scrolling works fine. So I’m not really sure if the emulators are 100% accurate._  
...
* **Edge**
  ...
  When testing on the Edge browser I encountered an issue with the image on the landing page. When the user scrolls the page the background image judders (_some sort of shaking_).   
...
**d.** _I moved the mouse over the navigation links and the green underline hover works as intended_   
...
**g.** _I clicked on menu links from the burger dropdown and selected each link I can verify that this works as intended._   
...
3. **Media**   
   ...
   **d.** _I clicked on each one of the 5 embedded new mixes and they all work as intended_   
...
* _**Images:**_ 
  ...
  * In the Media section club scene images, three of the images where sourced from Unsplash and one image from Pixabay. All the images come with a free to use for personal and commercial licence with no attribution  required.    
...
* _**Rotating CD Icon:**_
  ...
  * To create the rotating record/CD effect on mouse scroll I used some JavaScript snippet of code from Codepen.    
...
* _**Image Zoom**_
  ...
  * For the image zoom effect on the club scene images I got some ideas from a snippet of code from Codepen.   
  https://codepen.io/sara_bianchi94/pen/LLOVYy/

* _**Navbar collapse on selection:**_

  * To have the Navbar links collapse on selection I used and a little snippet of code with some help and information from Stackoverflow.        
  https://stackoverflow.com/questions/42401606/how-to-hide-collapsible-bootstrap-4-navbar-on-clic

### Inspiration 

* Some of the websites that gave me inspiration.
